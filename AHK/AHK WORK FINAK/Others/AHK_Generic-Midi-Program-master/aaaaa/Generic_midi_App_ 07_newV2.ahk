...
if (A_OSVersion ~= "^(?i:WIN_NT4|WIN_95|WIN_98|WIN_ME)$")  ; If not Windows XP or greater, quit program
{
...
IniRead("MidiDevices.ini") ; Load values from the ini file, via the readini function - see Midi_In_Out_Lib.ahk file
...
; midiMon()                             ; see below - a monitor gui - see Midi_In_Out_Lib.ahk file  COMMENT THIS OUT IF YOU DON'T WANT DISPLAY
